...
#./singlestepupgrade_run.sh 14.2.19.0.21 14.2.18.0.21 Here 14.2.19.0.21 is the current Sprint 19 build and 14.2.18.0.21 is the Sprint 18 build.
...
sed -i s/last_sprint_buildno/$old_Major_Version$old_Minor_Version$old_Type$old_Revision$old_Build/g campaign.xml
